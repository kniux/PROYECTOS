...
const int button1   = 7;                   // button1 pin number
const int button2   = 6;                   // button1 pin number
const int button3   = 5;                   // button1 pin number
const int buzzer_pin = 3;                   // Alarms pin number
